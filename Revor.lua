...
ControllerAll = false
local ListSudos ={Sudo_Id,5371850859}  
...
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5371850859 then
msg.Name_Controller = 'المطور جيكا '
msg.The_Controller = 1
...
download('https://raw.githubusercontent.com/Jeka-1/R/master/Revor.lua','Revor.lua')
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "مارك") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "مارك")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n✶︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "مارك")..
